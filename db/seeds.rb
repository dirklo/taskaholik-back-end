...
project1 = user1.created_projects.create(title: "Make a PB&J Sandwich", team_id: 1, deadline: DateTime.now + 7)


task1 = project1.tasks.create(title: 'Prepare Ingredients', creator_id: 1)
task1.details.create(content: "slice bread", creator_id: 1, deadline: DateTime.now + 2)
detail1 = task1.details.create(content: "open peanut butter jar", creator_id: 1, deadline: DateTime.now + 2)
detail1.comments.create(content: "This is going to take forever", author_id: 3)
task1.details.create(content: "open jelly jar", creator_id: 1, deadline: DateTime.now + 2)
...
task2.details.create(content: "plug in toaster", creator_id: 1, deadline: DateTime.now + 4)
detail2 = task2.details.create(content: "toast for PRECICELY 2 minutes", creator_id: 1, deadline: DateTime.now + 4)
...
task3.details.create(content: "apply jelly to side 1", creator_id: 1, deadline: DateTime.now + 5)
task3.details.create(content: "apply peanut butter to side 2", creator_id: 1, deadline: DateTime.now + 5)
detail3 = task3.details.create(content: "slap those bad-boys together", creator_id: 1, deadline: DateTime.now + 5)
...
task4.details.create(content: "cut sandwich diagnally", creator_id: 1, deadline: DateTime.now + 6)
task4.details.create(content: "present in center of white plate", creator_id: 1, deadline: DateTime.now + 6)
task4.details.create(content: "add chips to the side", creator_id: 1, deadline: DateTime.now + 6)
detail4 = task4.details.create(content: "deliver to customer", creator_id: 1, deadline: DateTime.now + 6)
